...
public class TestMaximumVariable 
{
    ...
    {
        Float maximum = new MaximumVariable<>(Arrays.asList(2.4f,5.6f,0.4f,7.7f,4.5f,9.9f)).maximumValue();
    ...
    {
        String maximum = new MaximumVariable<>(Arrays.asList("Apple","Peach","Banana","Horse","Snake")).maximumValue();
